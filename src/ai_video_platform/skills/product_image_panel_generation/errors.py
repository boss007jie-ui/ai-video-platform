...
class ImagePanelErrorCode(str, Enum):
    ...
    PANEL_PLAN_INVALID = "IMAGE_PANEL_PANEL_PLAN_INVALID"
    ANCHOR_MISMATCH = "IMAGE_PANEL_ANCHOR_MISMATCH"
    PANEL_PLAN_COVERAGE_INVALID = "IMAGE_PANEL_PANEL_PLAN_COVERAGE_INVALID"
    PANEL_USAGE_INVALID = "IMAGE_PANEL_PANEL_USAGE_INVALID"
    REFERENCE_BOARD_MISUSE = "IMAGE_PANEL_REFERENCE_BOARD_MISUSE"
    CONTINUITY_INVALID = "IMAGE_PANEL_CONTINUITY_INVALID"
