...
class ErrorCode(str, Enum):
    ...
    EVIDENCE_MISSING = "REFERENCE_ANALYSIS_EVIDENCE_MISSING"
    VISUAL_OBSERVATION_REQUIRED = "REFERENCE_ANALYSIS_VISUAL_OBSERVATION_REQUIRED"
    ANALYSIS_INCOMPLETE = "REFERENCE_ANALYSIS_INCOMPLETE"
    MEDIA_INVALID = "REFERENCE_ANALYSIS_MEDIA_INVALID"
    ARTIFACT_ROLE_FORBIDDEN = "REFERENCE_ANALYSIS_ARTIFACT_ROLE_FORBIDDEN"
